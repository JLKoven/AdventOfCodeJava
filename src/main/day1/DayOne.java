...
public class DayOne {
	...
	public static void executeStandardPart1() {
		...
		System.out.println(
				"Answer to part 1 is " + getAnswerPartOneImperative(getStandardInputDayOnePartOneAndTwo()) + ".");
	}
	...
	public static void executeStandardPart2() {
		...
		System.out.println(
				"Answer to part 2 is " + getAnswerPartTwoImperative(getStandardInputDayOnePartOneAndTwo()) + ".");
	}
