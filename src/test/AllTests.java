...
@RunWith(Suite.class)
@SuiteClasses({TestGeneral.class, TestDayOne.class, TestDayTwo.class, TestDayThree.class, TestDayFour.class, TestDayFive.class, TestDaySix.class, TestDaySeven.class})
